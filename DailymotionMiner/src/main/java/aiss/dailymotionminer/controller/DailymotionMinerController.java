...
public class DailymotionMinerController {
    ...
    public VMChannel sendToVideoMiner(
        ...
        VMChannel channel = service.getChannel(channelId, maxVideos, maxPages);
        service.sendToVideoMiner(channel);
        return channel;
    }


    // Versión de solo lectura: obtiene los datos del canal desde Dailymotion sin enviarlos a VideoMiner (para pruebas)
